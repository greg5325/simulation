...
//	std::cout << "zjh:gspan started" << std::endl;
	...
	freopen("input","r",stdin);//redirect the stdin
//	std::string s;
//	while(std::cin>>s){
//		std::cout<<s<<" ";
//	}
...
/*
 ...
 usage: gspan [-m minsup] [-D] [-e] [-w] [-L maxpat]

 options
 -h, show this usage help
 -m minsup, set the minimum support (absolute count)
 -D, use directed edges, default: undirected
 -e, output substructures in encoded form (?)
 -w, where (?)
 -L maxpat, the maximum number of outputted substructures
 -n minnodes, the minimum number of nodes in substructes (default: 0)
